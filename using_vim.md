...
Upon using `:set clipboard+=unnamedplus` I found that I could seemlessly copy/paste inbetween the system and Neovim. E.g. using `Ctrl+c` in the system and the using `p` within Neovimæ.
